...
export function SiteLanguageSwitcher() {
  ...
  return (
    <div className="relative grid h-11 w-full min-w-[120px] grid-cols-2 rounded-full border border-[#ead6dc] bg-white p-1 shadow-sm">
      <div
        className={cn(
          "absolute inset-y-1 rounded-full bg-[#f7eaee] transition-all duration-300",
